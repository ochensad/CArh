\begin{titlepage}
	...
	\begin{center}
		\Large\textbf{Отчёт по практикуму №1} \\
		\Large\textbf{по курсу «Архитектура ЭВМ»} \\
	\end{center}
	\vspace{2.5cm}
	
	\noindent\textbf{Тема} $\underline{\text{Разработка и отладка программ в вычислительном комплексе}}$\newline\newline
	$\underline{\text{Тераграф с помощью библиотеки leonhard x64 xrt}}$\newline\newline
